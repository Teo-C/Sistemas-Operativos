...
env_alloc(struct Env **newenv_store, envid_t parent_id)
{
	...
	*newenv_store = e;
	...
	#ifdef LT_SCHDLG
		int priority = random(ENVMAXTICKETS);
			e->priority =  priority;
...
// Modifies the priority of an Enviroment
// It also updates the total_tickets amount
void
env_modify_priority(struct Env* e, int priority)
{
	int current_priority = e->priority;
	total_tickets -= current_priority;
	e->priority = priority;
	total_tickets += priority;
}